    ...
    return (
        <div className={style.user}>
            <div className={style.userLeft}>
                <img src={props.imgURL} alt="face" className={style.userPic} />
            ...
            <div className={style.userRight}>
                <div className={style.userInfoTop}>
                    ...
                    <p className={style.location}>{props.location.city}<React.Fragment><br /></React.Fragment>{props.location.country}</p>
                </div>
